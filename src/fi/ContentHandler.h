 ...
 * @see FISAXParser
 */
class LIBFI_EXPORT ContentHandler
{
public:
  ...
  virtual void startElement(const ParserVocabulary* vocab, const Element &element, const std::vector<Attribute> &attributes) = 0;
 ...
 */
class LIBFI_EXPORT DefaultContentHandler : public ContentHandler
{
public:
  /// Destructor.
  ...
  virtual void startElement(const ParserVocabulary* vocab, const Element &element, const std::vector<Attribute> &attributes);
